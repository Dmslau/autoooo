//Sat Jul 06 2024 07:34:09 GMT+0000 (Coordinated Universal Time)
...
window.__require = function t(e, o, n) {
    ...
    var n,
      ...
      i = this && this.__decorate || function (t, e, o, n) {
        ...
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) {
          ...
          for (var a = t.length - 1; a >= 0; a--) if (r = t[a]) {
      ...
      s = this && this.__read || function (t, e) {
        ...
        var n,
          ...
          s = [];
        try {
          for (; (0 === e || e-- > 0) && !(n = i.next()).done;) s.push(n.value);
        } catch (a) {
          r = {
            error: a
          };
      ...
      u = (c.property, function (t) {
        ...
        e.canBeRemoved = function (t, e, o) {
          ...
          var n = s(this.isTurnOnce(t, e, o), 2),
            r = n[0],
            i = n[1];
          return r ? (this.routes.push(i), this.routes.push(e), !0) : !!this.isTurnTwice(t, e, o) && (this.routes.push(e), !0);
        };
        e.isHorizon = function (t, e, o) {
          if (t.y !== e.y) {
            return !1;
          }
          for (var n = Math.min(t.x, e.x), r = Math.max(t.x, e.x), i = n + 1; i < r; ++i) if (this.isBlocked(cc.v2(i, t.y), o)) {
            return !1;
          }
          return !0;
        };
        e.isVertical = function (t, e, o) {
          ...
          for (var n = Math.min(t.y, e.y), r = Math.max(t.y, e.y), i = n + 1; i < r; ++i) if (this.isBlocked(cc.v2(t.x, i), o)) {
            return !1;
          }
          return !0;
        };
        e.isTurnOnce = function (t, e, o) {
          var n = cc.v2(t.x, e.y),
            r = cc.v2(e.x, t.y);
          return !this.isBlocked(n, o) && (this.isHorizon(n, e, o) && this.isVertical(n, t, o) || this.isVertical(n, e, o) && this.isHorizon(n, t, o)) ? [!0, n] : !this.isBlocked(r, o) && (this.isHorizon(r, e, o) && this.isVertical(r, t, o) || this.isVertical(r, e, o) && this.isHorizon(r, t, o)) ? [!0, r] : [!1, null];
        };
        e.isTurnTwice = function (t, e, o) {
          var n;
          if (t.y === e.y) {
            for (var r = o[0].length - 1; r >= 0; --r) if (n = cc.v2(t.x, r), !this.isBlocked(n, o)) {
              var i = s(this.isTurnOnce(n, e, o), 2),
                a = i[0],
                c = i[1];
          ...
          for (r = o[0].length - 1; r >= 0; --r) if (n = cc.v2(t.x, r), !this.isBlocked(n, o)) {
        ...
        e.isImpasse = function (t) {
          this._findCnt = 0;
          for (var e = t.length, o = t[0].length, n = 1; n < e - 1; ++n) for (var r = 1; r < o - 1; ++r) {
            var i = t[n][r];
            if (i && this.isVaildId(i) && !this._subCheckImpasse(n, r, e, o, t)) {
              return !1;
            }
          }
          return !0;
        };
        e._subCheckImpasse = function (t, e, n, r, i) {
          for (var s = t; s < n - 1; ++s) for (var a = 1; a < r - 1; ++a) {
            var c = i[s][a];
            if (!(t == s && e >= a) && c && this.isVaildId(c) && (this._findCnt++, o.canBeRemoved(new cc.Vec2(t, e), new cc.Vec2(s, a), i))) {
              return !1;
            }
          }
          return !0;
    ...
    var n = this && this.__awaiter || function (t, e, o, n) {
      ...
      r = this && this.__generator || function (t, e) {
        ...
        function c(i) {
          ...
          for (; s;) try {
            o = 1;
            if (n && (2 & i[0] ? r = n.return : i[0] ? r = n.throw || ((r = n.return) && r.call(n), 0) : r = n.next) && !(r = r.call(n, i[1])).done) {
              return r;
            }
        ...
        return n(this, 0, 0, function () {
          ...
          return r(this, function (e) {
            switch (e.label) {
              case 0:
                {
                  return c.HttpRequest.isWeb ? (a.EVENT.emit(i.EventId.ON_ANTI_ADDICTION_SUC), [2]) : [4, p.default.inst.authentication()];
                }
              case 1:
                {
                  t = e.sent();
  ...
  AntiAddiction: [function (t, e, o) {
    ...
    var c = t("../../../Controller/AntiAddictionController"),
      ...
      v = function (t) {
        ...
        i([y(cc.Label)], e.prototype, "labName", 0);
        i([y(cc.Label)], e.prototype, "labIdCrad", 0);
        return i([_], e);
      }(h.default);
    o.default = v;
    cc._RF.pop();
    ...
    var i = t("../Common/Archive"),
      ...
      a = function (t) {
        ...
        e.prototype.initialize = function () {
          ...
          this._localData = i.default.createLocalData(this._userID);
        ...
        e.prototype.__saveLocalData = function () {
          i.default.saveLocalData(this._userID, this._localData);
        };
        return e;
      }(cc.Component);
    o.default = new a();
    ...
    var n = t("../Framework/Platform/Platform"),
      ...
      s = function () {
        ...
        t.prototype.createLocalData = function (t) {
          ...
          return e ? Object.assign(Object.assign({}, i), JSON.parse(e)) : i;
        };
        ...
        t.prototype.checkReportValid = function (t) {
          return !!t && (r.default.inst.getGameCode(), !0);
        };
        return t;
      }();
    o.default = new s();
            ...
            return r(this, function (f) {
              switch (f.label) {
                ...
                case 2:
                  {
                    f.trys.push([2, 7, 8, 9]);
                    n = i(Object.values(s.AUDIOS_PATH));
                    a = n.next();
                    f.label = 3;
                  }
                case 3:
  ...
  Bootstrap: [function (t, e, o) {
    ...
    var n,
      ...
      i = this && this.__assign || function () {
        return (i = Object.assign || function (t) {
          for (var e, o = 1, n = arguments.length; o < n; o++) for (var r in e = arguments[o]) if (Object.prototype.hasOwnProperty.call(e, r)) {
            t[r] = e[r];
          }
          return t;
    ...
    var l = t("../../Controller/AntiAddictionController"),
      ...
      p = t("../../Controller/PlatMgr"),
      f = t("../../Controller/TableMgr"),
      h = t("../../Define/Define"),
      d = t("../../Define/EventId"),
      _ = t("../../Framework/Event/EventMgr"),
      y = t("../../Framework/Platform/Platform"),
      v = t("../../Framework/Res/ResUtil"),
      m = t("../../Framework/Scene/SceneBase"),
      g = t("../../Framework/Scene/SceneMgr"),
      b = t("../../Framework/Utils/Utils"),
      I = t("../../Model/PlayerModel"),
      w = t("../../System/ArchiveSystem"),
      T = cc._decorator,
      S = T.ccclass,
      E = T.property,
      P = function (t) {
        ...
        e.prototype.onEnable = function () {
          _.EVENT.on(d.EventId.ON_LOGIN_RET, this.onLoginRet, this);
          _.EVENT.on(d.EventId.ON_ANTI_ADDICTION_SUC, this.onAntiAddiction, this);
        };
        e.prototype.onDisable = function () {
          _.EVENT.off(d.EventId.ON_LOGIN_RET, this.onLoginRet, this);
          _.EVENT.off(d.EventId.ON_ANTI_ADDICTION_SUC, this.onAntiAddiction, this);
        };
                ...
                case 0:
                  {
                    ...
                    w.default.initialize();
                    return [4, p.default.inst.init()];
                  }
                case 1:
                  {
                    t.sent();
          ...
          return a(this, 0, 0, function () {
            ...
            return c(this, function (o) {
              switch (o.label) {
                case 0:
                  {
                    t = b.default.getUrlParams("gameId");
                    e = b.default.getUrlParams("inviterId");
                    return [4, y.Platform.init(t, e)];
                  }
                case 1:
                  {
                    o.sent();
        ...
        e.prototype._goMain = function () {
          console.warn("789///");
          this._isLogin && this._isAdult && (u.default.inst.logCustomPerformance(), g.SCENE.loadScene(h.SceneType.Main));
        };
        s([E(cc.Prefab)], e.prototype, "uiRoot", 0);
        return s([S], e);
      }(m.default);
    o.default = P;
    cc._RF.pop();
  ...
  CommonDialog: [function (t, e, o) {
    ...
    var s = t("../../../Framework/UIBase"),
      ...
      u = function (t) {
        ...
        i([l(cc.Label)], e.prototype, "lblTittle", 0);
        i([l(cc.Label)], e.prototype, "lblDes", 0);
        i([l(cc.Label)], e.prototype, "lblCancelText", 0);
        i([l(cc.Label)], e.prototype, "lblAffirmText", 0);
        return i([c], e);
      }(s.default);
    o.default = u;
    cc._RF.pop();
  ...
  CommonToast: [function (t, e, o) {
    ...
    var s = t("../../Controller/ExLogCtr"),
      ...
      u = function (t) {
        ...
        i([l(cc.Node)], e.prototype, "item", 0);
        return i([c], e);
      }(cc.Component);
    o.default = u;
    cc._RF.pop();
  ...
  ConfirmView: [function (t, e, o) {
    ...
    var s = t("../UIBase"),
      ...
      f = function (t) {
        ...
        i([p(cc.Label)], e.prototype, "lblContent", 0);
        i([p(cc.Label)], e.prototype, "confirmTxt", 0);
        i([p(cc.Label)], e.prototype, "cancelTxt", 0);
        return i([u], e);
      }(s.default);
    o.default = f;
    cc._RF.pop();
  ...
  Detain: [function (t, e, o) {
    ...
    var c = t("../../../Controller/AfunRiskSDKController"),
      ...
      I = function (t) {
        ...
        i([b(cc.Label)], e.prototype, "labAwardNum", 0);
        i([b(cc.Sprite)], e.prototype, "sprAward", 0);
        i([b(cc.Label)], e.prototype, "labTaskDesc", 0);
        return i([g], e);
      }(y.default);
    o.default = I;
    cc._RF.pop();
  ...
  DoubleAwardController: [function (t, e, o) {
    ...
    var s = t("../Define/EventId"),
      ...
      h = function () {
        ...
        t.prototype.getNewAction = function (t, e, o, r) {
          0 === e && (e = null);
          0 === o && (o = null);
          0 === r && (r = {});
          ...
          return r(this, 0, 0, function () {
            ...
            return i(this, function (i) {
              switch (i.label) {
                ...
                case 1:
                  {
                    (r = i.sent()).status = u.default.inst.changeTaskStatus(r);
                    this._taskInfo = r;
                    console.log("\u5224\u5b9a\u4efb\u52a1\u9886\u53d6\u72b6\u6001", r.receiveType, l.MissionReceiveType.RECEIVE, " &&", r.receiveStatus, l.ReceiveStatus.TORECEIVE);
                    return r.receiveType != l.MissionReceiveType.RECEIVE || r.receiveStatus != l.ReceiveStatus.TORECEIVE ? [3, 3] : [4, u.default.inst.getTask(this._taskID.sMissionCollectionID, this._taskID.sMissionID)];
                  }
                case 2:
                  {
                    i.sent();
                ...
                case 3:
                  {
                    (null === (e = r.stage) || 0 === e ? 0 : e.count) ? null === (o = r.stage) || 0 === o ? d = 0 : d = o.count : d = 1;
                    null === (n = r.missionStageDTOS[d - 1]) || 0 === n ? _ = 0 : _ = n.rewardStatus;
                    console.log("\u5224\u5b9a\u4efb\u52a1\u5956\u52b1\u72b6\u6001", r.status, l.MissionStatusType.FINISH, "\u9886\u5956\u72b6\u6001", _);
                    return r.status != l.MissionStatusType.FINISH || _ == l.TaskRewardStatus.SUCCESS ? [3, 5] : [4, u.default.inst.getAward(r, this._extInfo)];
                  }
                case 4:
                  {
                    y = i.sent();
                ...
                case 5:
                  {
                    t || r.status != l.MissionStatusType.RUNNING ? this._failCallback && this._failCallback() : ((null === (null === (s = r.actionConfig) || 0 === s ? a = 0 : a = s.actionValue) || 0 === a ? 0 : a.executeOpportunity) ? f.default.inst.openBrowser(null === (null === (p = r.ext) || 0 === p ? h = 0 : h = p.extValue) || 0 === h ? 0 : h.missionActionUrl) : f.default.inst.openTaskBrowser(null === (c = r.ext.extValue) || 0 === c ? 0 : c.missionActionUrl, r), this._isDoing = !0);
                    return [3, 7];
                  }
                case 6:
                  {
    ...
    var n = t("../Common/Constant"),
      ...
      a = function () {
        ...
        t.prototype.getPicDropPools = function () {
          ...
          if (e % 2 == 0) {
            for (var o = s.default.getRandomPic(t), r = new Array(), i = 0; i < e / 2; i++) {
        ...
        t.prototype.getLevelDropPools = function () {
          var t = i.default.getCurMapConfig();
          return t ? 0 != t.asDefaultPools.length ? r.default.clone(t.asDefaultPools) : this.getCustomDropPools(t) : console.error("\u914d\u7f6e\u9519\u8bef-------------------");
        };
        t.prototype.getCustomDropPools = function (t) {
          var e = t.aiDropPoolsA,
            ...
            d = this._getSameAarry(n.LINK_GAME_OBSTACLE_ID.toString(), r[0]);
          i = i.concat(f, h, d);
          var _ = {};
          ...
          for (var y = this._getDropotalCount(e), v = this._getDropotalCount(o), m = this._getDropotalCount(r), g = this._getDropPicPool(u, y), b = this._getDropPicPool(p, v), I = this._getSameAarry(n.LINK_GAME_OBSTACLE_ID.toString(), m), w = t.aiDropPoolsA.length, T = 1; T < w; T++) {
            var S = g.splice(0, e[T]),
              E = b.splice(0, o[T]),
              P = I.splice(0, r[T]),
              O = new Array().concat(S, E, P);
            O.sort(function () {
              return Math.random() > .5 ? -1 : 1;
            });
            i = i.concat(O);
        ...
        t.prototype._getDropPicPool = function (t, e) {
          if (e % 2 == 0) {
            for (var o = new Array(), n = 0, r = 0; r < e / 2; r++) {
              var i = t[n];
              o.push(i);
              o.push(i);
              ++n >= t.length && (n = 0);
        ...
        t.prototype.getNextDropPlan = function (t) {
          var e = i.default.getCurMapConfig().aiDropCompound;
          if (e) {
  ...
  EffectLayerController: [function (t, e, o) {
    ...
    var s = t("../../../Common/Constant"),
      ...
      f = function (t) {
        ...
        i([p(cc.Prefab)], e.prototype, "faillParticle", 0);
        i([p(cc.Animation)], e.prototype, "hammerAni", 0);
        i([p(cc.Sprite)], e.prototype, "propSprite", 0);
        i([p([cc.SpriteFrame])], e.prototype, "propSpriteFrames", 0);
        return i([u], e);
      }(cc.Component);
    o.default = f;
    cc._RF.pop();
  ...
  EventObject: [function (t, e, o) {
    ...
    var c = t("../Utils/Utils"),
      ...
      p = function (t) {
        ...
        r(e, t);
        e.prototype.on = function (e, o, n, r) {
          ...
          l.realCallback = function () {
            ...
            var r = l.target;
            try {
              var i = l.args && l.args.filter(function (t) {
                  return null != t;
                }) || [],
              ...
              if (l.callback && r) {
                if (r instanceof cc.Component) {
                  ...
                  if (c.default.isComponentLive(p)) {
                    (t = l.callback).call.apply(t, s([r], u));
                  }
                } else {
                  (e = l.callback).call.apply(e, s([r], u));
                }
              } else {
                if (l.callback) {
        ...
        e.prototype.findEvent = function (t, e, o) {
          ...
          for (var r = 0; r < n.length; r++) if (n[r].callback === e && n[r].target == o) {
            return r;
          }
          return -1;
        };
    ...
    var n = t("../Define/UIDefs"),
      ...
      c = function () {
        ...
        t.prototype.openExit = function () {
          this._isFirstOpen ? (this.isTodayFirst() ? (i.default.inst.open(n.UIType.ExitGame), window.setSureExitBtn()) : i.default.inst.open(n.UIType.ExitShare), this._isFirstOpen = !1) : a.default.inst.closeWindow();
        };
        t.prototype.isTodayFirst = function () {
          var t;
          return null === (t = s.default.inst.gameTaskPro[r.default.DETAIN_TASK]) || 0 === t ? 0 : t.isFinishe;
        };
        return t;
      }();
    o.default = c;
  ...
  ExitGame: [function (t, e, o) {
    ...
    var s = t("../../Controller/LTrackerMgr"),
      ...
      p = function (t) {
        ...
        i([u(cc.Sprite)], e.prototype, "exitSpr", 0);
        return i([l], e);
      }(a.default);
    o.default = p;
    cc._RF.pop();
    ...
    var s = cc._decorator,
      ...
      l = function (t) {
        ...
        e.prototype.playFlyCoinAni = function (t, e) {
          ...
          n.stopAllActions();
          Math.random();
          var r = new cc.Vec2(e.x - 200, e.y - t.y);
          n.runAction(cc.sequence(cc.bezierTo(.6, [new cc.Vec2(t.x, t.y), r, new cc.Vec2(e.x, e.y)]).easing(cc.easeIn(1)), cc.callFunc(function () {
            o.coinPool.put(n);
          })));
        };
        ...
        i([c(cc.Prefab)], e.prototype, "coinPrefab", 0);
        i([c(cc.SpriteFrame)], e.prototype, "leYuanCoinSpr", 0);
        return o = i([a], e);
      }(cc.Component);
    o.default = l;
    cc._RF.pop();
        ...
        t._flyNextTxt = function () {
          ...
          if (this._flyList.length > 0 && this._currentShowCount < this._maxShowCount) {
            ...
            if (o) {
              ...
              var n = o.getComponent(r.default);
              n.setTxt(e.txt, e.color);
              var a = s.default.inst.getLayer(i.LayerType.Tip);
              a.addChild(o);
              o.setPosition(a.convertToNodeSpaceAR(e.pos));
              o.once(r.default.EVNENT_ON_FLY_ANI_COMPLETE, function () {
                t._currentShowCount--;
  ...
  FlyTxt: [function (t, e, o) {
    ...
    var s = cc._decorator,
      ...
      l = function (t) {
        ...
        i([c(cc.Label)], e.prototype, "lblTxt", 0);
        i([c(cc.Animation)], e.prototype, "flyAni", 0);
        return o = i([a], e);
      }(cc.Component);
    o.default = l;
    cc._RF.pop();
  ...
  GameDrop: [function (t, e, o) {
    ...
    var s = t("../../../Common/Constant"),
      ...
      h = function (t) {
        ...
        i([f(cc.Node)], e.prototype, "obstacleDrop", 0);
        i([f(cc.Label)], e.prototype, "lblTitle", 0);
        i([f(cc.Label)], e.prototype, "lblDes", 0);
        return i([p], e);
      }(c.default);
    o.default = h;
    cc._RF.pop();
  ...
  GameSettlement: [function (t, e, o) {
    ...
    var s = t("../../../Controller/LTrackerMgr"),
      ...
      y = function (t) {
        ...
        e.prototype.initView = function () {
          var t = f.Game.inst.getPlayTime(),
            e = l.default.getFormatingTimeStr(t);
          ...
          this._isSucc = o;
          o ? s.default.inst.expo("cx156019", {
            iplaytime: t,
            irise: u.default.isRevive ? 0 : 1,
            icount: this._para.CoinNum
          }) : s.default.inst.expo("cx156027", {
            failurereason: u.default.failType,
            irise: u.default.isRevive ? 0 : 1,
            droptimes: u.default.dropIdx
          });
        };
        e.prototype.onClickReplayBtn = function () {
        ...
        i([_(cc.Label)], e.prototype, "lblTime", 0);
        i([_(cc.Label)], e.prototype, "lblCoin", 0);
        i([_(cc.Node)], e.prototype, "succNode", 0);
        i([_(cc.Node)], e.prototype, "failNode", 0);
        return i([d], e);
      }(c.default);
    o.default = y;
    cc._RF.pop();
  ...
  GameTips: [function (t, e, o) {
    ...
    var s = t("../../../Common/Constant"),
      ...
      p = function (t) {
        ...
        i([u(cc.Label)], e.prototype, "lblTitle", 0);
        i([u(cc.Label)], e.prototype, "lblDes", 0);
        return i([l], e);
      }(a.default);
    o.default = p;
    cc._RF.pop();
  ...
  Game: [function (t, e, o) {
    ...
    var s = t("../../Common/Constant"),
      ...
      I = function (t) {
        ...
        i([b(cc.Node)], e.prototype, "removeBubble", 0);
        i([b(cc.Node)], e.prototype, "hintProp", 0);
        i([b(cc.Node)], e.prototype, "removeProp", 0);
        i([b(cc.ProgressBar)], e.prototype, "progressBar", 0);
        i([b(cc.ProgressBar)], e.prototype, "dropBar", 0);
        i([b([cc.Node])], e.prototype, "brightStars", 0);
        i([b(cc.Label)], e.prototype, "lblDropBatch", 0);
        i([b(cc.Node)], e.prototype, "dropNode", 0);
        i([b(cc.Node)], e.prototype, "timeNode", 0);
        i([b(cc.Label)], e.prototype, "lblSeason", 0);
        i([b(cc.Label)], e.prototype, "lblTime", 0);
        return o = i([g], e);
      }(f.default);
    o.Game = I;
    cc._RF.pop();
    ...
    var n = t("../Controller/TableMgr"),
      ...
      s = function () {
        ...
        t.prototype.startGame = function (t) {
          this.init();
          this.level = t;
          i.SCENE.loadScene(r.SceneType.Game);
        };
        t.prototype.backGame = function () {
          this.gamePause = !1;
        };
        t.prototype.backMainScene = function () {
          i.SCENE.loadScene(r.SceneType.Main);
        };
  ...
  GetItemLayer: [function (t, e, o) {
    ...
    var s = t("../../Common/AudioConfig"),
      ...
      _ = function (t) {
        ...
        i([d(cc.Label)], e.prototype, "labelAmount", 0);
        i([d(cc.Sprite)], e.prototype, "propSpr", 0);
        i([d(cc.Sprite)], e.prototype, "smallPropSpr", 0);
        return i([h], e);
      }(u.default);
    o.default = _;
    cc._RF.pop();
      ...
      v = function (t) {
        ...
        e.prototype.onWatchAbs = function () {
          return s(this, 0, 0, function () {
            var t = this;
            return a(this, function () {
              l.default.inst.getProp("D005", function (e) {
                t.setData(e);
  ...
  Handler: [function (t, e, o) {
    ...
    var n = function () {
      ...
      t.prototype.setTo = function (e, o, n, r) {
        0 === r && (r = !1);
        this._id = t._gid++;
        this.caller = e;
        this.method = o;
      ...
      t.create = function (e, o, n, r) {
        0 === n && (n = null);
        0 === r && (r = !0);
        return t._pool.length ? t._pool.pop().setTo(e, o, n, r) : new t(e, o, n, r);
      };
      t._pool = [];
      t._gid = 1;
      return t;
  ...
  Helper: [function (t, e, o) {
    ...
    var a = function (t) {
      ...
      e.prototype.labelVerbatim = function (t, e, o) {
        ...
        var r = this.verbatim(e);
        t.string = "";
        return new Promise(function (i) {
          n.schedule(function () {
            var e = r.next();
            e.done ? i() : t.string += e.value;
          }, o, e.length);
        });
      };
  ...
  HttpRequest: [function (t, e, o) {
    ...
    var n = t("../../Controller/MtopMgr"),
      ...
      a = function () {
        ...
        t.post = function (e, o, n, r, i) {
          0 === r && (r = {
            "Content-Type": "application/json"
          });
          0 === i && (i = 5);
          return t.isWeb ? this._doHttp(this._combURL(e, o), n, r, "POST", i) : this._doMtop(e, n);
        };
        t._doMtop = function (t, e) {
          ...
          return n.default.inst.dispatch(s.default.BIZ_SCENE, i, e);
        };
        t._doHttp = function (t, e, o, n) {
          var r = this;
          t = i.NetBase.sBaseURL + t;
      ...
      m = function (t) {
        ...
        e.prototype.initTick = function () {
          ...
          var o = f.default.getServerTime() - t.lastUpdateTime,
            ...
            r = Math.ceil(o / n);
          this._nextRefreshTime = t.lastUpdateTime + r * n;
        ...
        i([y(cc.Label)], e.prototype, "labelLifeLeft", 0);
        i([y(cc.Label)], e.prototype, "labelTimer", 0);
        i([y(cc.Node)], e.prototype, "nodeMore", 0);
        return i([_, v("\u997f\u4e86\u4e48/TiliShowController")], e);
      }(cc.Component);
    o.default = m;
    cc._RF.pop();
  }, {
      ...
      l = function (t) {
        ...
        e.prototype.updateEnergy = function () {
          var t = this._energy.lastUpdateTime,
            ...
            n = Number(i.TABLE.getGlobalById("G005").sGlobalData),
            r = 1e3 * Number(i.TABLE.getGlobalById("G006").sGlobalData);
          if (o > r && e < n) {
            var s = Math.floor(o / r);
            this._energy.num = Math.min(n, this._energy.num + s);
            this._energy.lastUpdateTime += s * r;
          }
        };
      ...
      u = function (t) {
        ...
        e.prototype.initialize = function (t, e, o) {
          ...
          for (var u = 0; u < t.length; u++) {
            ...
            r += f + this.spacing;
            this.itemsPos.push(l * (r - f));
            if (Number(u) + 1 >= a && Number(u) + 1 <= c) {
              this.content.addChild(p);
              var h = 0,
                d = 0;
              this.isVertical ? (d = f / 2 - r, h = this.spacing + p.width / 2 - this.content.width / 2) : (h = r - f / 2, d = this.spacing + p.height / 2 - this.content.height / 2);
              p.x = h;
              p.y = d;
              i++;
            }
          ...
          this.topIdx = a - 1;
          this.downIdx = c - 1;
          this.isVertical ? this.content.height = r : this.content.width = r;
          o && this.jumpTo(s - 1);
          return !0;
        };
        ...
        e.prototype.getItem = function (t) {
          for (var e = this.content.childrenCount, o = 0; o < e; ++o) {
            var n = this.content.children[o],
              r = n.getPosition();
            r = n.parent.convertToWorldSpaceAR(r);
            r = cc.director.getScene().convertToNodeSpaceAR(r);
            if (cc.rect(r.x - n.width / 2, r.y - n.height / 2, n.width, n.height).contains(t)) {
              return n;
            }
          }
          return null;
        ...
        e.prototype.getItemsLength = function (t) {
          ...
          return e - (this.isVertical ? i.height : i.width) / 2 - this.spacing;
        };
        e.prototype._updateContentView = function (t) {
          if (this.isInit && this.canUpdateFrame) {
            ...
            for (var n = this.getItemsHeight(), r = n / 2, i = 0; i < this.items.length; i++) {
              var s = this.items[i],
                a = this.getPositionInView(s);
              if (o) {
                if (this.isVertical && a.y < -r && (t || this.topIdx - 1 >= 0) || !this.isVertical && a.x > r && (t || this.topIdx - 1 >= 0)) {
                  this.topIdx--;
                  var c = this.topIdx,
                    l = 0;
                ...
                if (this.isVertical && a.y > r && (t || this.downIdx + 1 <= this.rowNum - 1) || !this.isVertical && a.x < -r && (t || this.downIdx + 1 <= this.rowNum - 1)) {
                  this.downIdx++;
                  c = this.downIdx;
                  l = 0;
        ...
        e.prototype.scrollTo = function (t, e) {
          ...
          var o = this.itemsPos[t],
            n = 0,
            r = 0;
          this.isVertical ? r = Math.abs(o) : n = o;
          this.listview.scrollToOffset(cc.v2(n, r), e);
        };
        e.prototype._getDownIdxs = function (t) {
          ...
          for (var o = 0, n = 0, r = 1; r <= t + 1; r++) {
            var i = Math.abs(this.itemsPos[r]);
            1 == r ? n += (i - o - this.spacing) / 2 + this.spacing : n += i - o;
          }
          if (n < e / 2) {
          ...
          var s = 0,
            a = 0;
          for (r = t + 1; r < this.itemsPos.length; r++) if (a++, i = Math.abs(this.itemsPos[r]), 1 == a ? s += (i - o - this.spacing) / 2 + this.spacing : s += i - o, o = i, s >= e / 2) {
            return r - 1;
          }
        ...
        e.prototype.jumpTo = function (t) {
          ...
          for (var n = 0; n < this.downIdx - this.topIdx + 1; n++) {
            var i = this.items[n],
              s = this.topIdx + n;
            this.itemUpdateFunc(s, i, this.data[s]);
            var a = i.getContentSize(),
              c = "x",
              l = a.width / 2;
            this.isVertical && (c = "y", l = -a.height / 2);
            i[c] = this.itemsPos[s] + l;
          }
          var u = 0,
            p = 0,
          ...
          if (this.isVertical) {
            ...
            if (this.initType == r.Bottom) {
              ...
              this.initType == r.Center ? (_ = this.getItemsLength(t - this.topIdx + 1), p += _, p = Math.max(p, this.listview.node.height / 2)) : this.initType == r.Top && (p = this.itemsPos[t] + this.listview.node.height / 2);
            }
            p = Math.min(d, p);
          } else {
            u = f;
            ...
            this.initType == r.Bottom ? 0 == this.topIdx ? u = this.listview.node.width / 2 : (_ = this.getItemsHeight(), u = u + _ - this.listview.node.width / 2) : this.initType == r.Center ? (_ = this.getItemsLength(t - this.topIdx + 1), u += _, u = Math.max(u, this.listview.node.width / 2)) : this.initType == r.Top && (u = this.itemsPos[t] + this.listview.node.width / 2);
            u = Math.max(v, -u);
          }
          this.scheduleOnce(function () {
  ...
  Loading: [function (t, e, o) {
    ...
    var s = t("../../Controller/LTrackerMgr"),
      ...
      y = function (t) {
        ...
        i([_(cc.ProgressBar)], e.prototype, "loadingBar", 0);
        i([_(cc.Label)], e.prototype, "lblProgress", 0);
        return i([d], e);
      }(p.default);
    o.default = y;
    cc._RF.pop();
  ...
  MD5: [function (t, e, o) {
    ...
    var n = function () {
      ...
      t.prototype.rstr2hex = function (t) {
        ...
        for (var e, o = this.hexcase ? "0123456789ABCDEF" : "0123456789abcdef", n = "", r = 0; r < t.length; r++) {
          e = t.charCodeAt(r);
      ...
      t.prototype.rstr2b64 = function (t) {
        ...
        for (var e = "", o = t.length, n = 0; n < o; n += 3) for (var r = t.charCodeAt(n) << 16 | (n + 1 < o ? t.charCodeAt(n + 1) << 8 : 0) | (n + 2 < o ? t.charCodeAt(n + 2) : 0), i = 0; i < 4; i++) 8 * n + 6 * i > 8 * t.length ? e += this.b64pad : e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(r >>> 6 * (3 - i) & 63);
        return e;
      };
      t.prototype.rstr2any = function (t, e) {
        ...
        var l = Math.ceil(8 * t.length / (Math.log(e.length) / Math.log(2))),
          u = Array(l);
        for (n = 0; n < l; n++) {
          for (s = Array(), i = 0, o = 0; o < c.length; o++) {
            i = (i << 16) + c[o];
      ...
      t.prototype.str2rstr_utf8 = function (t) {
        for (var e, o, n = "", r = -1; ++r < t.length;) {
          e = t.charCodeAt(r);
          r + 1 < t.length ? o = t.charCodeAt(r + 1) : o = 0;
          55296 <= e && e <= 56319 && 56320 <= o && o <= 57343 && (e = 65536 + ((1023 & e) << 10) + (1023 & o), r++);
      ...
      t.prototype.binl_md5 = function (t, e) {
        t[e >> 5] |= 128 << e % 32;
        t[14 + (e + 64 >>> 9 << 4)] = e;
        for (var o = 1732584193, n = -271733879, r = -1732584194, i = 271733878, s = 0; s < t.length; s += 16) {
          var a = o,
            c = n,
            l = r,
            u = i;
          o = this.md5_ff(o, n, r, i, t[s + 0], 7, -680876936);
          i = this.md5_ff(i, o, n, r, t[s + 1], 12, -389564586);
          r = this.md5_ff(r, i, o, n, t[s + 2], 17, 606105819);
          n = this.md5_ff(n, r, i, o, t[s + 3], 22, -1044525330);
          o = this.md5_ff(o, n, r, i, t[s + 4], 7, -176418897);
          i = this.md5_ff(i, o, n, r, t[s + 5], 12, 1200080426);
          r = this.md5_ff(r, i, o, n, t[s + 6], 17, -1473231341);
          n = this.md5_ff(n, r, i, o, t[s + 7], 22, -45705983);
          o = this.md5_ff(o, n, r, i, t[s + 8], 7, 1770035416);
          i = this.md5_ff(i, o, n, r, t[s + 9], 12, -1958414417);
          r = this.md5_ff(r, i, o, n, t[s + 10], 17, -42063);
          n = this.md5_ff(n, r, i, o, t[s + 11], 22, -1990404162);
          o = this.md5_ff(o, n, r, i, t[s + 12], 7, 1804603682);
          i = this.md5_ff(i, o, n, r, t[s + 13], 12, -40341101);
          r = this.md5_ff(r, i, o, n, t[s + 14], 17, -1502002290);
          n = this.md5_ff(n, r, i, o, t[s + 15], 22, 1236535329);
          o = this.md5_gg(o, n, r, i, t[s + 1], 5, -165796510);
          i = this.md5_gg(i, o, n, r, t[s + 6], 9, -1069501632);
          r = this.md5_gg(r, i, o, n, t[s + 11], 14, 643717713);
          n = this.md5_gg(n, r, i, o, t[s + 0], 20, -373897302);
          o = this.md5_gg(o, n, r, i, t[s + 5], 5, -701558691);
          i = this.md5_gg(i, o, n, r, t[s + 10], 9, 38016083);
          r = this.md5_gg(r, i, o, n, t[s + 15], 14, -660478335);
          n = this.md5_gg(n, r, i, o, t[s + 4], 20, -405537848);
          o = this.md5_gg(o, n, r, i, t[s + 9], 5, 568446438);
          i = this.md5_gg(i, o, n, r, t[s + 14], 9, -1019803690);
          r = this.md5_gg(r, i, o, n, t[s + 3], 14, -187363961);
          n = this.md5_gg(n, r, i, o, t[s + 8], 20, 1163531501);
          o = this.md5_gg(o, n, r, i, t[s + 13], 5, -1444681467);
          i = this.md5_gg(i, o, n, r, t[s + 2], 9, -51403784);
          r = this.md5_gg(r, i, o, n, t[s + 7], 14, 1735328473);
          n = this.md5_gg(n, r, i, o, t[s + 12], 20, -1926607734);
          o = this.md5_hh(o, n, r, i, t[s + 5], 4, -378558);
          i = this.md5_hh(i, o, n, r, t[s + 8], 11, -2022574463);
          r = this.md5_hh(r, i, o, n, t[s + 11], 16, 1839030562);
          n = this.md5_hh(n, r, i, o, t[s + 14], 23, -35309556);
          o = this.md5_hh(o, n, r, i, t[s + 1], 4, -1530992060);
          i = this.md5_hh(i, o, n, r, t[s + 4], 11, 1272893353);
          r = this.md5_hh(r, i, o, n, t[s + 7], 16, -155497632);
          n = this.md5_hh(n, r, i, o, t[s + 10], 23, -1094730640);
          o = this.md5_hh(o, n, r, i, t[s + 13], 4, 681279174);
          i = this.md5_hh(i, o, n, r, t[s + 0], 11, -358537222);
          r = this.md5_hh(r, i, o, n, t[s + 3], 16, -722521979);
          n = this.md5_hh(n, r, i, o, t[s + 6], 23, 76029189);
          o = this.md5_hh(o, n, r, i, t[s + 9], 4, -640364487);
          i = this.md5_hh(i, o, n, r, t[s + 12], 11, -421815835);
          r = this.md5_hh(r, i, o, n, t[s + 15], 16, 530742520);
          n = this.md5_hh(n, r, i, o, t[s + 2], 23, -995338651);
          o = this.md5_ii(o, n, r, i, t[s + 0], 6, -198630844);
          i = this.md5_ii(i, o, n, r, t[s + 7], 10, 1126891415);
          r = this.md5_ii(r, i, o, n, t[s + 14], 15, -1416354905);
          n = this.md5_ii(n, r, i, o, t[s + 5], 21, -57434055);
          o = this.md5_ii(o, n, r, i, t[s + 12], 6, 1700485571);
          i = this.md5_ii(i, o, n, r, t[s + 3], 10, -1894986606);
          r = this.md5_ii(r, i, o, n, t[s + 10], 15, -1051523);
          n = this.md5_ii(n, r, i, o, t[s + 1], 21, -2054922799);
          o = this.md5_ii(o, n, r, i, t[s + 8], 6, 1873313359);
          i = this.md5_ii(i, o, n, r, t[s + 15], 10, -30611744);
          r = this.md5_ii(r, i, o, n, t[s + 6], 15, -1560198380);
          n = this.md5_ii(n, r, i, o, t[s + 13], 21, 1309151649);
          o = this.md5_ii(o, n, r, i, t[s + 4], 6, -145523070);
          i = this.md5_ii(i, o, n, r, t[s + 11], 10, -1120210379);
          r = this.md5_ii(r, i, o, n, t[s + 2], 15, 718787259);
          n = this.md5_ii(n, r, i, o, t[s + 9], 21, -343485551);
          o = this.safe_add(o, a);
          n = this.safe_add(n, c);
          r = this.safe_add(r, l);
          i = this.safe_add(i, u);
      ...
      t.prototype.md5_cmn = function (t, e, o, n, r, i) {
        return this.safe_add(this.bit_rol(this.safe_add(this.safe_add(e, t), this.safe_add(n, i)), r), o);
      };
      t.prototype.md5_ff = function (t, e, o, n, r, i, s) {
        return this.md5_cmn(e & o | ~e & n, t, e, r, i, s);
      };
      t.prototype.md5_gg = function (t, e, o, n, r, i, s) {
        return this.md5_cmn(e & n | o & ~n, t, e, r, i, s);
      };
      t.prototype.md5_hh = function (t, e, o, n, r, i, s) {
        return this.md5_cmn(e ^ o ^ n, t, e, r, i, s);
      };
      t.prototype.md5_ii = function (t, e, o, n, r, i, s) {
        return this.md5_cmn(o ^ (e | ~n), t, e, r, i, s);
      };
    ...
    var M = function (t) {
      ...
      e.prototype.onClickStartBtn = function () {
        if (this._btnState == c.Pass) {
          ...
          return u.default.inst.click("cx155907.dx204411", {});
        }
      ...
      e.prototype._gain = function (t, e) {
        ...
        o.addChild(n);
        n.setPosition(r);
        var i = this.nodeMore.convertToWorldSpaceAR(cc.v2(0, 0)),
      ...
      i([R(cc.Sprite)], e.prototype, "btnSprite", 0);
      i([R([cc.SpriteFrame])], e.prototype, "btnSpriteFrames", 0);
      i([R(cc.Node)], e.prototype, "leYuanCoinNode", 0);
      i([R(cc.Label)], e.prototype, "labCoin", 0);
      i([R(cc.Label)], e.prototype, "lblReset", 0);
      i([R(cc.Node)], e.prototype, "nodeMore", 0);
      return i([N], e);
    }(m.default);
    o.Main = M;
    cc._RF.pop();
      ...
      O = function (t) {
        ...
        e.prototype.initMapArray = function () {
          ...
          for (var o = T.default.getCurMapConfig().sMapSet, n = 0; n < o.length; n++) {
            var r = n % f.LINK_GAME_ROW + 1,
              i = Math.floor(n / f.LINK_GAME_ROW) + 1;
            if ("0" == o[n]) {
              this._mapArray[r][i] = f.LINK_GAME_EMPTY_ID;
            }
          }
        };
        ...
        e.prototype.addPicItemToMap = function (t, e, o) {
          ...
          var r = this._getPicPosition(t, e);
          n.setPosition(r.x, r.y);
          var i = this._dropPicDatas.shift(),
            s = n.getComponent(P.Picitem);
          s.initItem(i, cc.v2(t, e));
          s.playDelayShow(o || 60 * e);
          this._mapArray[t][e] = i;
        ...
        e.prototype.checkPassGame = function () {
          ...
          try {
            for (var o = s(this._picItemCmpts), n = o.next(); !n.done; n = o.next()) {
              var r = n.value;
              if (r.picId != f.LINK_GAME_OBSTACLE_ID && r.picId != f.LINK_GAME_EMPTY_ID) {
                return !1;
              }
            }
          } catch (i) {
        ...
        e.prototype._uploadGame = function (t) {
          ...
          T.default.isSettlement || (console.log("Log - Test _uploadGame.......2"), T.default.isSettlement = !0, S.default.uploadGame(t));
        };
        e.prototype.refreshPicCmpt = function () {
          for (var t = this, e = new Array(), o = new Array(), n = 1; n < this._rows - 1; ++n) for (var r = 1; r < this._colmns - 1; ++r) {
            var i = this._mapArray[n][r];
            if (i && i != f.LINK_GAME_EMPTY_ID) {
              e.push({
                x: n,
                y: r
              });
        ...
        e.prototype.onRemovePic = function () {
          ...
          if (!this._inRefreshing && !this._isPlayAni && this._checkPropVaild(f.PROP_ID.RemoveObstacle)) {
            var o = !1;
            try {
              for (var n = s(this._picItemCmpts), r = n.next(); !r.done; r = n.next()) if (r.value.isObstacle()) {
                o = !0;
              }
            } catch (i) {
              t = {
        ...
        e.prototype.drawHintLine = function () {
          ...
          if (t && 0 != t.length) {
            for (var e = 1; e < t.length; e++) {
              var o = t[e - 1],
                n = t[e],
                r = this._getPicPosition(o.x, o.y),
                i = this._getPicPosition(n.x, n.y),
                s = this.flashs[e - 1].node;
              this.flashs[e - 1].play();
              s.active = !0;
              s.x = (r.x + i.x) / 2;
              s.y = (r.y + i.y) / 2;
              var a = Math.abs(r.x - i.x),
                c = Math.abs(r.y - i.y);
        ...
        i([l(cc.Node)], e.prototype, "picParent", 0);
        i([l(cc.Prefab)], e.prototype, "picPrefab", 0);
        i([l([cc.Animation])], e.prototype, "flashs", 0);
        i([l(E.default)], e.prototype, "effectLayer", 0);
        return i([c], e);
      }(cc.Component);
    o.MapController = O;
    cc._RF.pop();
  ...
  MeshPolygonSprite: [function (t, e, o) {
    ...
    var l = cc.gfx,
      ...
      y = function (t) {
          ...
          if (this.spriteFrame) {
            ...
            try {
              for (var f = c(this.vertexes), h = f.next(); !h.done; h = f.next()) {
                var d = h.value,
                  _ = this._lerp(i, s, (d.x + r.width / 2 + this.offset.x) / r.width),
                  y = this._lerp(a, u, (d.y + r.height / 2 - this.offset.y) / r.height);
                p.push(cc.v2(_, y));
              }
            } catch (v) {
              t = {
        ...
        i([f], e.prototype, "_offset", 0);
        i([f({
          type: cc.Vec2,
          tooltip: "\u4f4d\u7f6e\u504f\u79fb\u91cf"
        })], e.prototype, "offset", null);
        i([f], e.prototype, "_spriteFrame", 0);
        i([f({
          type: cc.SpriteFrame,
          tooltip: "\u7cbe\u7075\u7684\u7cbe\u7075\u5e27"
        })], e.prototype, "spriteFrame", null);
        i([f], e.prototype, "_vertexes", 0);
        i([f({
          type: cc.Vec2,
          tooltip: "\u9876\u70b9\u5750\u6807"
        })], e.prototype, "vertexes", null);
        return i([p, h, d(cc.MeshRenderer), _("ui-extensions/MeshPolygonSprite")], e);
      }(cc.Component);
    o.default = y;
    cc._RF.pop();
  }, {}],
      ...
      I = function (t) {
        ...
        e.prototype.onWatchAbs = function () {
          return s(this, 0, 0, function () {
            var t = this;
            return a(this, function () {
              u.default.inst.getProp("D006", function (e) {
        ...
        i([g(cc.Label)], e.prototype, "labPro", 0);
        i([g(cc.Node)], e.prototype, "nodeIcon", 0);
        return i([m, b("\u997f\u4e86\u4e48/MorePower")], e);
      }(d.default);
    o.default = I;
    cc._RF.pop();
  }, {
    ...
    var s = t("../Framework/Tools/BaseInfo"),
      ...
      u = function () {
        ...
        t.prototype._mtop = function (t, e, o, s) {
          0 === s && (s = !0);
          return r(this, 0, Promise, function () {
            var e;
  ...
  NetBase: [function (t, e, o) {
    ...
    o.NetBase = 0;
    var i = t("../Framework/Net/HttpRequest"),
      s = t("../Framework/Platform/Platform"),
      ...
      c = function () {
        ...
        t.get = function (t, e, o, n, r) {
          0 === n && (n = {
            "Content-Type": "application/json"
          });
          0 === r && (r = 5);
          return this.sendRequset("get", t, e, o, n, r);
        };
        t.post = function (t, e, o, n, r) {
          0 === n && (n = {
            "Content-Type": "application/json"
          });
          0 === r && (r = 5);
          var i = s.Platform.getGameId(),
            c = a.default.inst.getToken();
          o || (o = {});
          c && c.length > 0 && (o.gameId = i, o.token = c);
          return this.sendRequset("post", t, e, o, n, r);
        };
        t.accountPost = function (t, e, o, n, r) {
          0 === n && (n = {
            "Content-Type": "application/json"
          });
          0 === r && (r = 5);
          ...
          return n(this, 0, Promise, function () {
            ...
            return r(this, function (r) {
              switch (r.label) {
                case 0:
                  {
                    switch (t.toLocaleLowerCase()) {
                      case "get":
                        {
                          n = i.HttpRequest.get(e, o, c, l);
                          break;
                        }
                      case "post":
                        {
                          n = i.HttpRequest.post(e, o, s, c, l);
                          break;
                        }
                      default:
                        {
                ...
                case 1:
                  {
                    if (p = r.sent(), i.HttpRequest.isWeb) {
      ...
      i = function () {
        ...
        t.prototype.init = function () {
          ...
          if (this._isReady) {
            ...
            "string" != typeof arguments[0] ? console.error("NodePool init error " + arguments[0]) : r.resLoader.loadRes(arguments[0], cc.Prefab, function (e, n) {
        ...
        t.prototype.destory = function () {
          var t, e;
          try {
            for (var o = n(this._nodes), r = o.next(); !r.done; r = o.next()) r.value.destroy();
          } catch (i) {
            t = {
              error: i
            };
  ...
  ObjectUtils: [function (t, e, o) {
    ...
    var n = function () {
      ...
      t.getPropertyByNames = function (t, e) {
        ...
        for (var r = t, i = 0; i < o.length && r; i++) {
          var s = o[i];
          if (null === r[s] || 0 === r[s]) {
            break;
          }
          r = r[s];
          if (i === o.length - 1 && null != r) {
            return r;
          }
        }
        return e;
      ...
      t.getPropertyStringByNames = function (t, e) {
        for (var o = [], n = 2; n < arguments.length; n++) o[n - 2] = arguments[n];
        for (var r = t, i = e, s = 0; s < o.length && r; s++) {
          var a = o[s];
          if (null === r[a] || 0 === r[a]) {
            break;
          }
          r = r[a];
          if (s === o.length - 1 && null != r) {
            var c = r;
            "string" == typeof c ? i = c : "number" == typeof c && (i = c.toString());
            break;
          }
        }
        return i;
      ...
      t.getPropertyNumberByNames = function (t, e) {
        ...
        for (var r = t, i = e, s = 0; s < o.length && r; s++) {
          ...
          if (s === o.length - 1 && null != r) {
            var c = r;
            "number" == typeof c ? i = c : "string" == typeof c && (i = parseInt(c));
            break;
          }
        }
        return i;
      ...
      _ = function (t) {
        ...
        e.prototype._canMove = function (t) {
          ...
          var n = u.default.getServerTime(),
            r = Math.abs(e),
            i = (n - this.startTime) / 1e3;
          return r >= o / 2 || r > 25 && r / i >= this.speed;
        };
        e.prototype._touchEnded = function (t) {
          if ((!this.isVertical || this.scrollView.vertical) && (this.isVertical || this.scrollView.horizontal)) {
            ...
            var n = this._canMove(e),
              r = e.x - this.startPos.x,
              i = this.itemWidth;
            if (n) {
              var s = 1;
              this.isVertical && (s = -1);
              r > 0 ? this.pageIdx = this.pageIdx - s : this.pageIdx = this.pageIdx + s;
            }
            ...
            var u = this.getItemPosition(this.pageIdx),
              p = u.x - i / 2,
              f = cc.v2(p, 0);
            this.isVertical && (p = u.y - i / 2, f = cc.v2(0, p));
        ...
        e.prototype.setData = function (e, o, n) {
          ...
          if (this.indicator == s.Show) {
            var r = this.listview.node.getChildByName("_indicator_");
            if (!r) {
              var i = (r = new cc.Node("_indicator_")).addComponent(cc.Layout);
              i.type = cc.Layout.Type.HORIZONTAL;
              i.horizontalDirection = cc.Layout.HorizontalDirection.LEFT_TO_RIGHT;
              r.height = this.indicatorBGSize;
              r.x = 0;
              r.y = -this.node.height / 2 + this.indicatorBGSize / 2 + 5;
              i.spacingX = this.indicatorSpacing;
              this.isVertical && (i.type = cc.Layout.Type.VERTICAL, i.verticalDirection = cc.Layout.VerticalDirection.TOP_TO_BOTTOM, r.width = this.indicatorBGSize, r.height = 0, r.y = 0, r.x = -this.node.width / 2 + this.indicatorBGSize / 2 + 5, i.spacingY = this.indicatorSpacing);
              this.indicatorNode = r;
        ...
        e.prototype._createArrows = function () {
          ...
          if (!(!this.arrow || e <= o || this.arrows)) {
            ...
            var r = cc.v2(-this.listview.node.width / 2 + n.height / 2 + 20, 0),
              i = -90;
            this.isVertical && (r = cc.v2(0, this.listview.node.height / 2 - n.height / 2 - 20), i = 180);
            n.angle = i;
            n.setPosition(r);
            n.name = "_leftArrow_";
            ...
            r = cc.v2(this.listview.node.width / 2 - s.height / 2 - 20, 0);
            i = 90;
            this.isVertical && (r = cc.v2(0, -this.listview.node.height / 2 + s.height / 2 + 20), i = 0);
            s.angle = i;
            s.setPosition(r);
            s.name = "_rightArrow_";
        ...
        i([d(cc.SpriteFrame)], e.prototype, "pageIdxBg", 0);
        i([d(cc.SpriteFrame)], e.prototype, "pageIdxIcon", 0);
        i([d], e.prototype, "indicatorBGSize", 0);
        i([d], e.prototype, "indicatorSelSize", 0);
        i([d], e.prototype, "indicatorSpacing", 0);
        return i([h], e);
      }(p.default);
    o.default = _;
    cc._RF.pop();
              ...
              return [2, new Promise(function (e) {
                cc.resources.loadDir(t.skinPath, cc.SpriteFrame, null, function (o, n) {
                  o || 0 === n.length ? s.default.inst.showToast("skin load error .....") : (n.forEach(function (e) {
                    Number(e.name) == i.LINK_GAME_OBSTACLE_ID ? t._obstacleFrames = e : t.picSpriteFrames[Number(e.name)] = e;
                  }), e(n));
                });
              })];
            });
  ...
  Picitem: [function (t, e, o) {
    ...
    var s = cc._decorator,
      ...
      _ = function (t) {
        ...
        i([c(cc.Sprite)], e.prototype, "iconSpr", 0);
        i([c(cc.Animation)], e.prototype, "picAni", 0);
        i([c(cc.Node)], e.prototype, "selectedNode1", 0);
        i([c(cc.Node)], e.prototype, "selectedNode2", 0);
        i([c(cc.Node)], e.prototype, "apperNode", 0);
        i([c(cc.Node)], e.prototype, "particleNode", 0);
        i([c(cc.Node)], e.prototype, "brokenNode", 0);
        return i([a], e);
      }(cc.Component);
    o.Picitem = _;
    cc._RF.pop();
                ...
                case 1:
                  {
                    ...
                    window.document.addEventListener("WV.Event.APP.Active", function () {
                      ...
                      s.EVENT.emit(i.EventId.ON_SHOW);
                      s.EVENT.emit(i.EventId.ON_REFRESH_COIN);
                    }, !1);
                    ...
                    m.default.inst.getTaskList();
                    window.openExitDialog = function () {
                      f.default.inst.openExit();
                    };
                    return [2];
                  }
              }
  ...
  PlatformWX: [function (t, e, o) {
    ...
    var n = t("../Common/Helper"),
      ...
      s = function () {
        ...
        t.prototype.__createVideoAd = function () {
          var t = this;
          if (i.WX_CONFIG.AD_ID.video) {
            this._rewardVideo = wx.createRewardedVideoAd({
              adUnitId: i.WX_CONFIG.AD_ID.video
            });
        ...
        t.prototype.__createBannerAd = function () {
          if (i.WX_CONFIG.AD_ID.banner) {
            var t = wx.getSystemInfoSync();
            this._bannerAd = wx.createBannerAd({
              adUnitId: i.WX_CONFIG.AD_ID.banner,
              style: {
                left: 0,
                top: 0,
        ...
        t.prototype.__createInterstitialAd = function () {
          if (i.WX_CONFIG.AD_ID.interstitial) {
            this._interstitialAd = wx.createInterstitialAd({
              adUnitId: i.WX_CONFIG.AD_ID.interstitial
            });
          }
        };
        t.prototype.__createCustomAd = function () {
          if (i.WX_CONFIG.AD_ID.custom) {
            var t = wx.getSystemInfoSync();
            this._customAd = wx.createCustomAd({
              adUnitId: i.WX_CONFIG.AD_ID.custom,
              adIntervals: 60,
              style: {
        ...
        t.prototype.__createGridAd = function () {
          if (i.WX_CONFIG.AD_ID.grid) {
            var t = wx.getSystemInfoSync();
            this._gridAd = wx.createGridAd({
              adUnitId: i.WX_CONFIG.AD_ID.grid,
              adTheme: "white",
              gridCount: 5,
              style: {
  ...
  Platform: [function (t, e, o) {
    ...
    (function (t) {
      ...
      t[t.TaoBao = 1] = "TaoBao";
      t[t.WeiXin = 2] = "WeiXin";
    })(i = o.PlatformType || (o.PlatformType = {}));
    var p = function () {
      function t() {}
      t.init = function (e, o) {
        return n(this, 0, 0, function () {
    ...
    var n = t("../Common/Constant"),
      ...
      u = function () {
        ...
        t.prototype.setGameItemState = function (t, e) {
          ...
          o && (o[t] = e);
          i.EVENT.emit(r.EventId.ON_UPDATE_PROP_STATE);
        };
        ...
        t.prototype.updateItems = function (t) {
          ...
          i.EVENT.emit(r.EventId.ON_ITEM_CHANGE);
        };
        t.prototype.addItem = function (t, e) {
          if (!this._items[t]) {
            ...
            return i.EVENT.emit(r.EventId.ON_ITEM_CHANGE);
          }
          this._items[t].num += e;
          i.EVENT.emit(r.EventId.ON_ITEM_CHANGE);
        };
  ...
  PlayerSystem: [function (t, e, o) {
    ...
    var i = t("../Common/Constant"),
      ...
      d = t("../Framework/Scene/SceneMgr"),
      _ = t("../Framework/UI/UIMgr"),
      y = t("../Model/PlayerModel"),
      v = t("../Network/Net"),
      m = t("../View/Scene/Game"),
      g = t("../View/UI/Power/LifeSystem"),
      b = t("./GamingSystem"),
      I = function () {
        function t() {
          this._sendMsgFlag = !1;
        ...
        t.prototype.startGame = function () {
          return n(this, 0, 0, function () {
            var t = this;
            return r(this, function () {
              return this._sendMsgFlag ? [2] : (this._sendMsgFlag = !0, v.Net.startGame().then(function (e) {
                t._sendMsgFlag = !1;
                var o = e.data;
                o.energy && g.default.initialize(o.energy, o.infiniteEnergyAdNum);
                console.log("startGame .......", o);
                if (o) {
                  b.default.tutorialFlag = o.tutorialFlag;
                  var n = o.levelId;
                  if (!c.TABLE.getLevel(n)) {
                    _.default.inst.showToast("\u656c\u8bf7\u671f\u5f85\u540e\u7eed\u5173\u5361~");
                    return t.__backToMainScene();
                  }
                  s.default.inst.report("" + s.AfunRiskSDKType.enterLevel + n);
                  y.default.inst.startNewGame(o.gameCode, n);
                }
              }).catch(function (e) {
                console.log("start Game error ......................", e);
                t._sendMsgFlag = !1;
                "LOCK_OF_PROPS" == e && _.default.inst.open(f.UIType.GetPower);
              }), [2]);
            });
          });
        };
        t.prototype.__backToMainScene = function () {
          if (d.SCENE.getCurrentScene() == u.SceneType.Game) {
            d.SCENE.loadScene(u.SceneType.Main);
          }
        };
        t.prototype.addItemByWatchAd = function (t) {
          console.log("\u64ad\u653e\u89c6\u9891\u83b7\u5f97\u9053\u5177...................", t);
          y.default.inst.getGameCode();
          y.default.inst.isWatchOver(t) ? _.default.inst.showToast("\u5df2\u7ecf\u8865\u5145\u8fc7\u8fd9\u4e2a\u9053\u5177\u4e86\u54e6~") : l.default.inst.getProp(t, function () {
            b.default.backGame();
            _.default.inst.showToast("\u83b7\u5f97\u9053\u5177\uff0c\u5feb\u53bb\u95ef\u5173\u5427~");
            y.default.inst.setGameItemState(t, i.GAME_ITEM_STATE.UnUse);
            h.EVENT.emit(p.EventId.ON_NEW_PROP_DROP_ACTION, t);
            var e = c.TABLE.getItem(t);
            a.default.inst.click("cx157899", {
              sitemname: e.sName,
              icount: 1
            });
          }, function () {
            b.default.backGame();
            _.default.inst.showToast("\u83b7\u5f97\u9053\u5177\u5931\u8d25~");
          });
        };
        t.prototype.uploadGame = function (t) {
          var e = this;
          console.log("Log - Test _uploadGame.......3");
          var o = y.default.inst.getGameCode(),
            n = t ? m.Game.inst.getPlayTime() : 0,
            r = b.default.level;
          t && (s.default.inst.report("" + s.AfunRiskSDKType.completeLevel + r), Number(r) > 1 && (s.default.inst.report(s.AfunRiskSDKType.completeAll), s.default.inst.report(s.AfunRiskSDKType.getCoin)));
          v.Net.settlement(o, n).then(function (o) {
            var n,
              r,
              i = o.data;
            console.log("settlement..........ret", i);
            var s = i.lastLevelId;
            y.default.inst.levelId = s;
            var a = e._isPassLevelId(s);
            if (t && !a) {
              b.default.difficultySpike = !0;
              e.startGame();
            } else {
              var l = c.TABLE.getGlobalById("G002").sGlobalData;
              _.default.inst.open(f.UIType.GameSettlement, {
                isSucc: t,
                CoinNum: "D001" == (null === (n = o.data.rewardItems[0]) || 0 === n ? 0 : n.id) ? null === (r = o.data.rewardItems[0]) || 0 === r ? 0 : r.num : l
              });
            }
            ...
            t && (y.default.inst.levelId = (Number(y.default.inst.levelId) + 1).toString());
            var o = c.TABLE.getGlobalById("G002").sGlobalData;
            _.default.inst.open(f.UIType.GameSettlement, {
              isSucc: t,
              CoinNum: o
            });
        ...
        t.prototype._isPassLevelId = function (t) {
          return null == c.TABLE.getLevel(t);
        };
        return t;
      }();
    o.default = new I();
  ...
  ProgressController: [function (t, e, o) {
    ...
    var s = t("../../../Define/EventId"),
      ...
      h = function (t) {
        ...
        i([f(cc.ProgressBar)], e.prototype, "progressBar", 0);
        return o = i([p], e);
      }(cc.Component);
    o.default = h;
    cc._RF.pop();
  ...
  PropItemController: [function (t, e, o) {
    ...
    var s = t("../../../Common/Constant"),
      ...
      h = function (t) {
        ...
        i([f(cc.Label)], e.prototype, "lblNum", 0);
        i([f(cc.Node)], e.prototype, "lockNode", 0);
        i([f(cc.Node)], e.prototype, "normalNode", 0);
        i([f(cc.Node)], e.prototype, "addNode", 0);
        return i([p], e);
      }(cc.Component);
    o.default = h;
    cc._RF.pop();
  ...
  RTProfiler: [function (t, e, o) {
    ...
    var d = function () {
      ...
      t.showStats = function () {
        r || (l(), a && (a.active = !0), cc.director.on(cc.Director.EVENT_BEFORE_UPDATE, p), cc.director.on(cc.Director.EVENT_AFTER_UPDATE, f), cc.director.on(cc.Director.EVENT_AFTER_DRAW, h), r = !0);
      };
    ...
    var u = function () {
      ...
      t.prototype.emitParticle = function (t) {
        ...
        var u = e._startColor,
          ...
          f = e._endColor,
          h = e._endColorVar;
        n.color.r = r = o(u.r + p.r * (Math.random() - .5) * 2, 0, 255);
        n.color.g = i = o(u.g + p.g * (Math.random() - .5) * 2, 0, 255);
        n.color.b = s = o(u.b + p.b * (Math.random() - .5) * 2, 0, 255);
        n.color.a = a = o(u.a + p.a * (Math.random() - .5) * 2, 0, 255);
        n.deltaColor.r = (o(f.r + h.r * (Math.random() - .5) * 2, 0, 255) - r) / c;
        n.deltaColor.g = (o(f.g + h.g * (Math.random() - .5) * 2, 0, 255) - i) / c;
      ...
      t.prototype.updateUVs = function (t) {
        ...
        if (e) {
          ...
          if (o && this.sys._renderSpriteFrame) {
            for (var n = 4 * e._vfmt._bytes / 4, r = o._vData, i = this.sys._renderSpriteFrame.uv, s = i[4], a = i[5], c = i[2] - i[4], l = i[3] - i[5], u = this.sys.textureAnimationModule.numTilesX, p = c / u, f = l / this.sys.textureAnimationModule.numTilesY, h = t ? 0 : this._uvFilled, d = this.particles.length, _ = h; _ < d; _++) {
              var y = this.particles[_],
                v = _ * n;
              this._updateBuffUV(r, v, y, s, a, p, f, u);
            }
            this._uvFilled = d;
          }
        }
        ...
        if (e) {
          ...
          if (o && this.sys._renderSpriteFrame) {
            var n = 4 * e._vfmt._bytes / 4,
              ...
              h = this.particles[t],
              d = t * n;
            this._updateBuffUV(r, d, h, s, a, p, f, u);
          }
        }
      };
      t.prototype._updateBuffUV = function (t, e, o, n, r, i, s, a) {
        t[e + 2] = n + o.frameIndex % a * i;
        t[e + 3] = r + Math.floor(o.frameIndex / a) * s + s;
        t[e + 7] = n + o.frameIndex % a * i + i;
        t[e + 8] = r + Math.floor(o.frameIndex / a) * s + s;
        t[e + 12] = n + o.frameIndex % a * i;
        t[e + 13] = r + Math.floor(o.frameIndex / a) * s;
        t[e + 17] = n + o.frameIndex % a * i + i;
        t[e + 18] = r + Math.floor(o.frameIndex / a) * s;
      };
      ...
      t.prototype.step = function (t) {
        ...
        if (e.positionType === u.FREE) {
          ...
          e.positionType === u.RELATIVE ? (this._worldRotation = o.angle, i.x = o.x, i.y = o.y) : this._worldRotation = 0;
        }
  ...
  RTTextureAnimation: [function (t, e, o) {
    ...
    var r = cc._decorator,
      ...
      a = (r.disallowMultiple, cc.Enum({
        ...
        return n([i("RTTextureAnimation")], t);
      }());
    o.default = a;
    cc._RF.pop();
  }, {}],
  RTTextureParticleSystem: [function (t, e, o) {
    ...
    var s = t("./RTSimulator"),
      ...
      d = function (t) {
        ...
        i([u], e.prototype, "_textureAnimationModule", 0);
        i([u({
          type: a.default,
          animatable: !1
        })], e.prototype, "textureAnimationModule", null);
        return i([l, p, f, h(99)], e);
      }(cc.ParticleSystem);
    o.default = d;
    cc._RF.pop();
  }, {
    ...
    var i = t("../Model/PlayerModel"),
      ...
      l = function () {
                ...
                case 2:
                  {
                    n = r.sent();
                    i = n.data;
                    o.data.selfRankInfo.score = i.passTime;
                    r.label = 3;
                  }
                case 3:
                  {
        ...
        t.prototype.getDateStringByNow = function () {
          var t = new Date(i.default.inst.getServerTime()),
            e = t.getFullYear(),
            o = t.getMonth() + 1,
            n = t.getDate();
        ...
        t.changeStr = function (t, e) {
          ...
          for (var o = 0, n = "", r = 0; r < t.length; r++) {
            t.charCodeAt(t[r]) > 127 || 94 == t.charCodeAt(t[r]) ? o += 2 : o++;
            if (o > e) {
              n += "...";
              break;
            }
  ...
  RankItem: [function (t, e, o) {
    ...
    var s = t("../../../Controller/RankController"),
      ...
      p = function (t) {
        ...
        i([u(cc.Sprite)], e.prototype, "sprIcon", 0);
        i([u(cc.Label)], e.prototype, "labName", 0);
        i([u(cc.Label)], e.prototype, "labTime", 0);
        i([u(cc.Label)], e.prototype, "labNo", 0);
        return i([l], e);
      }(cc.Component);
    o.default = p;
    cc._RF.pop();
      ...
      y = function (t) {
        ...
        e.prototype._freshMyInfo = function () {
          ...
          if (null === (t = this._myInfo) || 0 === t ? 0 : t.userInfo) {
            ...
            this._myInfo.score ? (this.labMyTime.string = u.default.getFormatingTimeStr(Number(this._myInfo.score)), (null === (r = this._myInfo) || 0 === r ? 0 : r.no) ? (this.labMyNo.string = this._myInfo.no + "", this.labMyNo.fontSize = 54) : (this.labMyNo.string = "100+", this.labMyNo.fontSize = 46)) : (this.labMyTime.string = "\u672a\u901a\u5173", this.labMyNo.string = "");
          }
        };
        i([_(c.default)], e.prototype, "scroll", 0);
        i([_(cc.Sprite)], e.prototype, "sprMyIcon", 0);
        i([_(cc.Label)], e.prototype, "labMyName", 0);
        i([_(cc.Label)], e.prototype, "labMyTime", 0);
        i([_(cc.Label)], e.prototype, "labMyNo", 0);
        i([_(cc.Node)], e.prototype, "nodeNothing", 0);
        return i([d], e);
      }(l.default);
    o.default = y;
    cc._RF.pop();
    ...
    var n = t("../Framework/Net/HttpRequest"),
      ...
      s = function () {
        ...
        t.prototype.request = function (t, e) {
          var o = this;
          if (!n.HttpRequest.isWeb) {
            var s = "ONLINE" == r.default.ENV ? "production" : "ppe";
            return new Promise(function (n, r) {
              o._sdk.request({
                ...
                i.default.inst.logApiError(o.data, t);
                r(o);
              });
            });
          }
  ...
  ResLeakChecker: [function (t, e, o) {
    ...
    var n = function () {
      ...
      t.findCharPos = function (t, e, o) {
        for (var n = t.indexOf(e), r = n, i = 0; i < o; i++) {
      ...
      t.prototype.logLoad = function (e, o, n) {
        if (this.checkFilter(e)) {
          ...
          var r = this._log.get(e);
          r.has(o) && console.warn("ResLeakChecker doubel same use " + e + " : " + o + ", stack " + r[o]);
          r.set(o, n || t.getCallStack(2));
        }
      };
  ...
  ResUtil: [function (t, e, o) {
    ...
    var r = function () {
      ...
      t.assignWith = function (e, o, n) {
        var r = t.getResKeeper(o, n);
        return r && e ? (r.autoReleaseRes(e), e) : (console.error("AssignWith " + e + " to " + o + " faile"), null);
      };
    ...
    var s = t("../../Common/Constant"),
      ...
      m = function (t) {
        ...
        e.prototype.onClickRevive = function () {
          var t = this;
          a.default.inst.click("cx155995.dx204587", {});
          l.default.inst.getProp("D002", function () {
        ...
        i([v(cc.Label)], e.prototype, "lblDes", 0);
        return i([y], e);
      }(h.default);
    o.default = m;
    cc._RF.pop();
    ...
    var r = t("../Common/Constant"),
      ...
      c = function () {
        ...
        t.prototype.initMapArray = function () {
          this._rows = r.LINK_GAME_ROW + 2;
          this._colmns = r.LINK_GAME_COLMN + 2;
          this._mapArray = [];
          for (var t = 0; t < this._rows; ++t) {
            this._mapArray[t] = Array(this._colmns);
            for (var e = 0; e < this._colmns; ++e) this._mapArray[t][e] = 0;
          ...
          for (var o = a.default.getCurMapConfig().sMapSet, n = 0; n < o.length; n++) {
            var i = n % r.LINK_GAME_ROW + 1,
              s = Math.floor(n / r.LINK_GAME_ROW) + 1;
            if ("0" == o[n]) {
              this._mapArray[i][s] = r.LINK_GAME_EMPTY_ID;
            }
          }
        };
        t.prototype.initPicInMap = function () {
          for (var t = 1; t < this._rows - 1; ++t) for (var e = 1; e < this._colmns - 1; ++e) if (this._mapArray[t][e] != r.LINK_GAME_EMPTY_ID) {
        ...
        t.prototype.removeHintPic = function () {
          var t = i.AlgorithmSystem.routes,
            e = t[0],
            o = t[t.length - 1];
        ...
        t.prototype.refreshPicCmpt = function () {
          for (var t = this, e = new Array(), o = new Array(), n = 1; n < this._rows - 1; ++n) for (var i = 1; i < this._colmns - 1; ++i) {
            var s = this._mapArray[n][i];
            if (s && s != r.LINK_GAME_EMPTY_ID) {
              e.push({
                x: n,
                y: i
              });
        ...
        t.prototype.onCheckImpasse = function () {
          return i.AlgorithmSystem.isImpasse(this._mapArray);
        };
        ...
        t.prototype.checkPassGame = function () {
          ...
          for (var t = 1; t < this._rows - 1; ++t) for (var e = 1; e < this._colmns - 1; ++e) {
            ...
            if (o != r.LINK_GAME_OBSTACLE_ID && o != r.LINK_GAME_EMPTY_ID && 0 != o) {
              return !1;
            }
          }
          this.levelSuccess();
    ...
    var h = function (t) {
      ...
      e.prototype.onDraw = function (t) {
        ...
        var e = this.node,
          ...
          r = -o * e.anchorX,
          i = -n * e.anchorY;
        t.roundRect(r, i, o, n, this.radius || 0);
        cc.game.renderType === cc.game.RENDER_TYPE_CANVAS ? t.stroke() : t.fill();
      };
      i([c], e.prototype, "_radius", 0);
      i([c({
        tooltip: "\u5706\u89d2\u534a\u5f84:\n0-1\u4e4b\u95f4\u4e3a\u6700\u5c0f\u8fb9\u957f\u6bd4\u4f8b\u503c, \n>1\u4e3a\u5177\u4f53\u50cf\u7d20\u503c"
      })], e.prototype, "radius", null);
      return i([a(), l(!0), u(!0), p(cc.Mask), f("Renderer Component/Mask(RoundRect)")], e);
    }(cc.Component);
    o.default = h;
    cc._RF.pop();
  }, {}],
        ...
        e.prototype._doLoadScene = function (t, e) {
          ...
          cc.director.preloadScene(t.sceneName, function (t, e) {
            ...
            o ? (cc.error("\u573a\u666f\u52a0\u8f7d\u5931\u8d25", o), e >= 0 ? (_.EVENT.emit(f.EventId.ON_UPDATE_LOADING_TTP, "\u7f51\u7edc\u4f3c\u4e4e\u4e0d\u592a\u597d"), setTimeout(function () {
              ...
              t ? cc.error("\u573a\u666f\u5207\u6362\u5931\u8d25", t) : (u.default.inst.close(p.UIType.Loading), r._loadSceneEnd());
            });
          });
        };
      ...
      s = function () {
        ...
        t.prototype.schedule = function (t, e, o, n, s) {
          ...
          p.realCallback = function (t) {
            ...
            try {
              if (p.callback) {
                (e = p.callback).call.apply(e, r([p.traget], n));
              }
            } catch (i) {
      ...
      l = function (t) {
        ...
        e.prototype.initialize = function (t, e) {
          ...
          for (var o = 0, n = 0; n < this.spawnCount; n += this.colCount) {
            for (var r = -this.itemHeight * (.5 + o) - this.spacing * (o + 1), i = 0; i < this.colCount; i++) {
              var s = n + i,
                a = null;
              s >= this.items.length ? (a = cc.instantiate(this.itemTemplate), this.items.push(a)) : a = this.items[s];
              this.content.addChild(a);
              var c = (i + .5) * this.itemWidth + this.spacing * (i + 1) - this.content.width / 2;
              a.setPosition(c, r);
              a.itemId = s;
        ...
        e.prototype.getItem = function (t) {
          for (var e = this.content.childrenCount, o = 0; o < e; ++o) {
            ...
            r = n.parent.convertToWorldSpaceAR(r);
            r = cc.director.getScene().convertToNodeSpaceAR(r);
            if (cc.rect(r.x - n.width / 2, r.y - n.height / 2, n.width, n.height).contains(t) && n.itemId <= this.data.length - 1) {
              return n;
            }
          }
          return null;
        ...
        e.prototype._updateContentView = function () {
          if (this.isInit && this.canUpdateFrame) {
            this.canUpdateFrame = !1;
            for (var t = this.items, e = this.scrollView.content.y < this.lastContentPosY, o = (this.itemHeight + this.spacing) * this.cacheRow, n = 0, r = 0; r < t.length; r += this.colCount) {
              var i = this.getPositionInView(t[r]);
              if (e) {
                n = t[r].y + o;
                if (i.y < -this.bufferZone && n < 0) {
                ...
                n = t[r].y - o;
                if (i.y > this.bufferZone && n > -this.content.height) {
        ...
        e.prototype.scrollTo = function (t) {
          ...
          this.items.forEach(function (t, n) {
            var r = Math.floor(n / e.colCount);
            t.y = 0 - (o + r + 1) * (e.itemHeight + e.spacing) + e.itemHeight / 2;
        ...
        i([c(cc.Prefab)], e.prototype, "itemTemplate", 0);
        i([c], e.prototype, "spacing", 0);
        i([c], e.prototype, "visibleRowCount", 0);
        i([c], e.prototype, "extraCahe", 0);
        i([c], e.prototype, "colCount", 0);
        return i([a], e);
      }(cc.Component);
    o.default = l;
    cc._RF.pop();
              ...
              case 3:
                {
                  ...
                  p = "eleme://sns_share_v2?channels=" + this._channels + "&shareTitleIcon=" + this._shareTitleIcon + "&shareTitle=" + this._shareTitle + "&title=" + s + "&text=" + encodeURIComponent(a) + "&url=" + encodeURIComponent(r) + "&image=" + c + "&posterInfo=" + encodeURIComponent(JSON.stringify(l));
  ...
  TabControl: [function (t, e, o) {
    ...
    var a = cc._decorator,
      ...
      u = function () {
        ...
        i([l(cc.Sprite)], t.prototype, "tab", 0);
        i([l(cc.SpriteFrame)], t.prototype, "select", 0);
        i([l(cc.SpriteFrame)], t.prototype, "unselect", 0);
        return i([c("TabProperty")], t);
      }(),
      p = function (t) {
        function e() {
          var e = null !== t && t.apply(this, arguments) || this;
        ...
        e.prototype.setSelect = function (t) {
          for (var e, o, n = 0; n < this.tabs.length; ++n) if (n == t) {
            ...
            try {
              for (var r = (e = 0, s(this.tabs)), i = r.next(); !i.done; i = r.next()) {
                var a = i.value;
                if (a != this.tabs[n]) {
        ...
        i([l([u])], e.prototype, "tabs", 0);
        i([l(cc.Component.EventHandler)], e.prototype, "clickHandler", 0);
        i([l()], e.prototype, "selectIdx", 0);
        return i([c], e);
      }(cc.Component);
    o.default = p;
    cc._RF.pop();
  ...
  TableMgr: [function (t, e, o) {
    ...
    o.TABLE = 0;
    var i = t("../Framework/Res/ResLoader"),
      ...
      c = function () {
          ...
          return n(this, 0, Promise, function () {
            ...
            return r(this, function () {
              return this._isLoaded ? [2] : (this._isLoaded = !0, [2, new Promise(function (e) {
                i.resLoader.loadRes("Config/_filelist_", cc.JsonAsset, function (o, n) {
        ...
        t.prototype.loadTable = function (t, e) {
          ...
          var o = this;
          cc.resources.load(t, cc.JsonAsset, function (n, r) {
            if (n) {
              ...
              if (e) {
                try {
                  ...
                  cc.error("loadTable->", i + " res:" + t);
                  a.default.inst.logJsError(i);
                }
              }
            }
            o._onInitOver();
        ...
        t.prototype._initLevel = function () {
          ...
          this.loadTable("Config/Level", function (e, o) {
            for (var n = Object.keys(o.json), r = 0; r < n.length; ++r) {
              var i = o.json[n[r]];
              t._level.set(i.sID, i);
            }
          });
        };
  ...
  TaskController: [function (t, e, o) {
    ...
    var i = t("../Framework/Platform/Platform"),
      ...
      f = function () {
        ...
        t.prototype._classifyTask = function (t, e) {
          ...
          for (var o = t.mlist ? t.mlist.length : 0, n = 0; n < o; n++) {
            var r = t.mlist[n];
            r.status = this.changeTaskStatus(r);
            if ((r.actionConfig.actionType != a.TaskItemType.OPEN_APP_PUSH || !a.default.inst.netSubAwardStauts) && r.receiveType != a.MissionReceiveType.RECEIVE) {
              switch (e || r.missionDefId != s.default.ENTRY_TASK_ID || r.status != a.MissionStatusType.RUNNING || i.Platform.getUrlInfo(s.default.ENTRY_TASK_KEY) == s.default.ENTRY_TASK_VALUE && this.pageTask(r), r.status) {
                case a.MissionStatusType.RUNNING:
                  {
                    a.default.inst.setAcceptptTaskList(r);
                    a.TaskItemType.OPEN_APP_PUSH == r.actionConfig.actionType && this.refreshTaskInfo(r);
                    break;
                  }
                case a.MissionStatusType.FINISH:
                  {
                    a.default.inst.setAwardingTaskList(r);
                    break;
                  }
                default:
                  {
                    a.default.inst.setCompleteTaskList(r);
                  }
              }
            }
          }
          ...
          return n(this, 0, 0, function () {
            ...
            return r(this, function (r) {
              switch (r.label) {
                ...
                case 1:
                  {
                    return [2, null == (n = r.sent()) ? 0 : n.data.mlist[0]];
                  }
              }
            });
          });
          ...
          return n(this, 0, 0, function () {
            ...
            return r(this, function (r) {
              switch (r.label) {
                ...
                case 1:
                  {
                    return e.missionDefId != s.default.ENTRY_TASK_ID ? [3, 4] : i.Platform.getUrlInfo(s.default.ENTRY_TASK_KEY) != s.default.ENTRY_TASK_VALUE ? [3, 3] : [4, this.pageTask(e)];
                  }
                case 2:
                  {
                    r.sent();
    ...
    var n,
      ...
      s = function () {
        ...
        t.prototype.reduceTask = function (t, e) {
          ...
          i.EVENT.emit(r.EventId.ON_REFRESH_TASK);
        };
        t.taskInfo = {};
        return t;
      }();
          ...
          return n(this, 0, 0, function () {
            ...
            return r(this, function (r) {
              switch (r.label) {
                case 0:
                  {
                    return i.HttpRequest.isWeb ? [2, e()] : this._taskList ? [3, 2] : (n = this, [4, this.getTaskList()]);
                  }
                case 1:
                  {
                    n._taskList = r.sent();
  ...
  UIBase: [function (t, e, o) {
    ...
    var d = function (t) {
      ...
      i([h()], e.prototype, "quickClose", 0);
      i([h({
        type: cc.Enum(a.LayerType)
      })], e.prototype, "showLayer", 0);
      i([h()], e.prototype, "cache", 0);
      i([h()], e.prototype, "maskOpacity", 0);
      return i([f], e);
    }(u.default);
    o.default = d;
    cc._RF.pop();
  ...
  UIEffectMgr: [function (t, e, o) {
    ...
    var s = t("../Sys/TeMap"),
      ...
      v = function (t) {
        ...
        e.prototype.onLoad = function () {
          o._inst = this;
          for (var t = 0; t < this.effectConfigs.length; ++t) for (var e = this.effectConfigs[t], n = e.effectTypes, r = 0; r < n.length; ++r) this._effectGroupMap.set(n[r], e.group);
          for (t = 0; t < this.effectPrefabs.length; ++t) {
            var i = this.effectPrefabs[t],
              s = i.prefab,
              a = new u.NodePool();
            a.init(s);
            this._effectPool.set(i.effectType, a);
            this._effectPrefabMap.set(i.effectType, s);
          }
        };
        e.prototype.addEffect = function (t, e, o, n) {
          0 === e && (e = !0);
          0 === n && (n = !0);
          var r = this.createEffect(t, e, n);
          if (!r) {
            cc.error("add effect fail!");
            return null;
          }
          var i = this._effectGroupMap.get(t);
          i && (i.addChild(r), o && r.setPosition(i.convertToNodeSpaceAR(o)));
          return r.getComponent(c.default);
        };
        e.prototype.createEffect = function (t, e, o) {
          0 === e && (e = !0);
          0 === o && (o = !0);
          var n = null,
            r = this._effectPool.get(t);
          r && (n = r.getNode());
          if (!n) {
            var i = this._effectPrefabMap.get(t);
            if (!i) {
              cc.error("effect prefab not found!");
              return null;
            }
            n = l.ResUtil.instantiate(i);
          }
          if (n) {
    ...
    var i = t("./UIMgr"),
      ...
      u = function () {
          ...
          return n(this, 0, Promise, function () {
            return r(this, function () {
              return [2, new Promise(function (n) {
                i.default.inst.open(s.UIType.Confirm, {
                  content: t,
                  confirmBtnTxt: e,
                  cancelBtnTxt: o
                });
        ...
        t.showLoading = function (t) {
          i.default.inst.showSceneLoadUI(t);
        };
        t.hideLoading = function () {
          i.default.inst.hideSceneLoadUI();
        };
        t.flyTxt = function (t, e, o) {
    ...
    var g = function (t) {
      ...
      e.prototype.open = function (t, e, o) {
        ...
        if (this.isOpening || this.isClosing) {
          ...
          return this.UIOpenQueue.push(r);
        }
        if (-1 == this.getUIIndex(t)) {
          r.zOrder = this.UIStack.length + 1;
          this.UIStack.push(r);
          var i = s.UIDataInfo.getUIData(t);
          i.preventTouch && this.showWaitMask && (r.preventNode = this.preventTouch(r.zOrder), r.preventNode.opacity = 0);
          this.isOpening = !0;
          i.showWaitMask && this.showUIWaitAnim();
          this.getOrCreateUI(t, o, function (o) {
            n.hideUIWaitAnim();
            if (r.isClose || null == o) {
              cc.log("getOrCreateUI " + t + " faile! close state : " + r.isClose + " , uiView : " + o, "%s");
              n.isOpening = !1;
      ...
      e.prototype.closeToUI = function (t, e, o) {
        ...
        if (-1 != n) {
          o ? n = n : n = n + 1;
          for (var r = this.UIStack.length - 1; r >= n; --r) {
            var i = this.UIStack.pop(),
              s = i.uiType,
              a = i.uiView;
            i.isClose = !0;
      ...
      e.prototype.close = function (t, e) {
        ...
        var n,
          r = this.UIStack.length;
        if (t > s.UIType.$Start && t < s.UIType.$End) {
          if (r < 1 || this.isClosing || this.isOpening || !this.isUIOpen(t)) {
      ...
      e.prototype.updateUI = function () {
        ...
        for (var r = t; r < e; ++r) this.UIStack[r].uiView.node.active = !1;
      };
      e.prototype.getOrCreateUI = function (t, e, n, r) {
        var i = this.UICache[t];
        if (i) {
          n(i);
        } else {
          ...
          u.resLoader.loadRes(l, e, function (e, s) {
            if (e) {
              ...
              if (null == (i = c.getComponent(a.default))) {
              ...
              i.node.width = p.width;
              i.node.height = p.height;
              i.__prefab__ = s;
              s.addRef();
              i.init(r, t);
              n(i);
      ...
      e.prototype.onUIOpen = function (t, e, o, n) {
        ...
        if (null != e) {
          ...
          if (e.quickClose) {
            var i = e.node.getChildByName("background");
            i || ((i = new cc.Node()).name = "background", i.setContentSize(cc.winSize), i.x = (.5 - e.node.anchorX) * cc.winSize.width, i.y = (.5 - e.node.anchorY) * cc.winSize.height, e.node.addChild(i, -1));
            i.targetOff(cc.Node.EventType.TOUCH_START);
          ...
          var c = function () {
              e.isPlayOpenAni = !1;
              e.onOpenAniOver();
              r.uiOpenDelegate && r.uiOpenDelegate(t, a);
      ...
      i([m(cc.Node)], e.prototype, "guiLayer", 0);
      i([m(cc.Node)], e.prototype, "popLayer", 0);
      i([m(cc.Node)], e.prototype, "tipLayer", 0);
      i([m(cc.Node)], e.prototype, "topLayer", 0);
      i([m(cc.Node)], e.prototype, "uiWaitNode", 0);
      i([m(cc.Node)], e.prototype, "waitMask", 0);
      i([m(cc.Node)], e.prototype, "sceneWaitNode", 0);
      i([m(cc.Label)], e.prototype, "sceneWaitLbl", 0);
      i([m(cc.Prefab)], e.prototype, "tipsNode", 0);
      i([m(cc.Prefab)], e.prototype, "uiBack", 0);
      return o = i([v], e);
    }(cc.Component);
    o.default = g;
    cc._RF.pop();
    ...
    var r = t("../../Define/UIDefs"),
      i = function () {
        ...
        t.containsPointPolygon = function (t, e, o) {
          for (var n = t, r = t.length, i = r - 2, s = !1, a = 0; a < r; a += 2) {
            var c = n[a + 1],
              l = n[i + 1];
            if (c < o && l >= o || l < o && c >= o) {
              var u = n[a];
              if (u + (o - c) / (l - c) * (n[i] - u) < e) {
                s = !s;
              }
            }
            i = a;
        ...
        t.getBoundingBoxAMPolygon = function (t, e, o) {
          var n,
            r = e.findSlot(o);
          if (r) {
            var i = r.getAttachment();
            if (i && i instanceof sp.spine.BoundingBoxAttachment) {
              var s = i;
              n = sp.spine.Utils.newFloatArray(s.worldVerticesLength);
              s.computeWorldVertices(r, 0, s.worldVerticesLength, n, 0, 2);
        ...
        t.deepCopy = function (t) {
          var e,
            ...
            r = {};
          try {
            for (var i = n(Object.keys(t)), s = i.next(); !s.done; s = i.next()) {
              var a = s.value;
              "object" == typeof t[a] ? r[a] = this.deepCopy(t[a]) : r[a] = t[a];
            }
          } catch (c) {
            e = {
              error: c
        ...
        t.formatDate = function (t, e) {
          ...
          for (var r in /(y+)/.test(e) && (e = e.replace(RegExp.$1, (o.getFullYear() + "").substr(4 - RegExp.$1.length))), n) if (new RegExp("(" + r + ")").test(e)) {
          ...
          if ("object" == typeof t) {
            if (null === t) {
              ...
              if (t instanceof Array) {
                ...
                for (var r in e = {}, t) e[r] = this.clone(t[r]);
              }
            }
          } else {
            e = t;
        ...
        t.getViewType = function (t) {
          for (var e = r.UIType.$Start + 1; e < r.UIType.$End; ++e) if (r.UIType[e] == t) {
            return e;
          }
        };
        ...
        t.arab2char = function (t) {
          var e = ["\u96f6", "\u4e00", "\u4e8c", "\u4e09", "\u56db", "\u4e94", "\u516d", "\u4e03", "\u516b", "\u4e5d"],
            o = ["", "\u5341", "\u767e", "\u5343", "\u4e07"],
            n = function (t) {
              for (var n = t.toString().split("").reverse(), r = "", i = 0; i < n.length; i++) r = (0 == i && 0 == n[i] ? "" : i > 0 && 0 == n[i] && 0 == n[i - 1] ? "" : e[n[i]] + (0 == n[i] ? o[0] : o[i])) + r;
              return r;
            },
            r = Math.floor(t / 1e4),
            i = t % 1e4,
            s = "";
          i.toString().length < 4 && (s = "0" + i);
          return r ? n(r) + "\u4e07" + n(s) : n(t);
        };
        t.updatePolygonCollider = function (t, e) {
          var o = t.points,
            n = t.world.points;
          n.length = o.length;
          for (var r = cc.v2(), i = 1e6, s = 1e6, a = -1e6, c = -1e6, l = 0, u = o.length; l < u; l++) {
            n[l] || (n[l] = cc.v2());
            r.x = o[l].x + e.x;
            r.y = o[l].y + e.y;
            var p = r.x,
        ...
        t.loadSpriteFrame = function (t, e, o) {
          var n = this;
          cc.resources.load(t, cc.SpriteFrame, function (t, r) {
        ...
        t.playFlying = function (t, e, o, n) {
          ...
          try {
            ...
            cc.tween(r).to(1, {
              ...
              progress: function (e, o, n, i) {
                n = e + (o - e) * i + 100 * Math.sin(i * Math.PI) * -1;
                t.x = r.x;
                return n;
              }
            }).call(function () {
  ...
  WatchAD: [function (t, e, o) {
    ...
    var s = t("../../../Common/Constant"),
      ...
      _ = function (t) {
        ...
        i([d(cc.Sprite)], e.prototype, "propSpr", 0);
        i([d(cc.Label)], e.prototype, "lblName", 0);
        i([d(cc.Label)], e.prototype, "lblDes", 0);
        i([d([cc.SpriteFrame])], e.prototype, "spriteFrames", 0);
        return i([h], e);
      }(l.default);
    o.default = _;
    cc._RF.pop();
  ...
  Wrapper: [function (t, e, o) {
    ...
    var n = function () {
      ...
      r = function () {
        ...
        t.scheduleFunction = function (t, e, o, r, i) {
          var s = this;
          if (t && t.isLive() && e) {
            var a = new n();
            a.target = t;
            ...
            a.tempCb = function (e) {
              try {
                ...
                n.customInfo = "interval?: " + o + ", repeat?: " + r + ", delay?: " + i;
                console.error(n);
              }
            };
            t.schedule(a.tempCb, o, r, i);
  ...
  i18nLabel: [function (t, e, o) {
    ...
    var s = t("./i18nMgr"),
      ...
      d = function (t) {
        ...
        return i([c, u, f(cc.Label), p, h("\u591a\u8bed\u8a00/i18nLabel")], e);
      }(cc.Component);
    o.i18nLabel = d;
    cc._RF.pop();
  }, {
  ...
  i18nMgr: [function (t, e, o) {
    ...
    var r = function () {
      ...
      t.reloadSprite = function () {
        var t, e;
        try {
          for (var o = n(this.spriteArr), r = o.next(); !r.done; r = o.next()) r.value._resetValue();
        } catch (i) {
          t = {
            error: i
          };
  ...
  i18nSprite: [function (t, e, o) {
    ...
    var s = t("../Res/ResKeeper"),
      ...
      _ = function (t) {
        ...
        return i([l, p, h(cc.Sprite), f, d("\u591a\u8bed\u8a00/i18nSprite")], e);
      }(s.default);
    o.i18nSprite = _;
    cc._RF.pop();
  }, {
