//Sat Jul 06 2024 11:26:07 GMT+0000 (Coordinated Universal Time)
...
async function jindu(_0x4b1643, _0x5bad07, _0x236d3a, _0x3f1a5a) {
  ...
  if (_0x17b2e0["data"] && _0x17b2e0["data"]["result"]) {
    ...
    if (Number(_0x2674d9['amount']) >= Number(_0x2674d9["maxAmount"])) {
      console["log"]("🎉🎉 任务完成，已获得", _0x2674d9["reduction"], _0x2674d9["threshold"]);
      process["exit"](0);
    }
  }
}
          ...
          if (_0x3eaef6["data"] && _0x3eaef6["data"]["result"]) {
            ...
            if (_0x3eaef6["data"]["success"]) {
              ...
              if (_0x275336["data"] && _0x275336["data"]['result']) {
                ...
                let amount = parseFloat(_0x2214c6["popWindow"]["content"][0]["amount"]);
                count_num += amount;
                console.log("本次运行总现金：【" + count_num.toFixed(2) + "】");
